...
export default function ContactPage() {
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        <h1 className="text-xl md:text-2xl font-body font-bold">Kontakt</h1>
        <p className="text-sm md:text-base text-foreground/70 mt-1">Kontakt ma'lumotlarini o'zgartirish</p>
      </div>
