  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl md:text-2xl font-body font-bold">Sertifikatlar</h1>
          <p className="text-sm md:text-base text-foreground/70 mt-1">Sertifikatlarni boshqarish</p>
        </div>
      ...
      <SectionMetaEditor section="certificates" />
