    ...
    <section id="gallery" ref={ref} className="py-24 md:py-32">
      <div className="container px-6 text-center">
        <div className="mb-16 animate-in-view">
          <p className="text-sm tracking-[0.3em] uppercase text-primary mb-3">{t("gallery.label")}</p>
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-foreground">{t("gallery.title")}</h2>
        </div>
