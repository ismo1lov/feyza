...
const AboutSection = () => {
  ...
  const values = about ? [
    { icon: Shield, title: about.value1_title, desc: about.value1_desc },
    { icon: Award, title: about.value2_title, desc: about.value2_desc },
    { icon: Heart, title: about.value3_title, desc: about.value3_desc },
  ] : [];
    ...
    <section id="about" ref={ref} className="py-24 md:py-32 gradient-warm">
      <div className="container px-6">
        <div className="max-w-3xl mx-auto text-center mb-16 animate-in-view">
          ...
          <h2 className="font-heading text-3xl md:text-5xl font-bold text-foreground mb-6">{about?.title || t("about.title")}</h2>
          <p className="text-muted-foreground text-base md:text-lg leading-relaxed">{about?.description || t("about.desc")}</p>
        </div>
