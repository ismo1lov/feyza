...
export default function About() {
  ...
  if (loading || !form) {
    return (
      <div className="max-w-3xl mx-auto">
        <div className="bg-white rounded-2xl border border-border p-4 md:p-6 animate-pulse space-y-4">
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      <div>
        <h1 className="text-xl md:text-2xl font-body font-bold">Bizning tarix</h1>
        <p className="text-sm md:text-base text-foreground/70 mt-1">Tarix bo'limi ma'lumotlarini o'zgartirish</p>
      </div>

      <form onSubmit={handleSubmit} className="bg-white rounded-2xl border border-border p-4 md:p-6 space-y-6">
