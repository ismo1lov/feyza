  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
          <h1 className="text-xl md:text-2xl font-body font-bold">FAQ</h1>
          <p className="text-sm md:text-base text-foreground/70 mt-1">Savol-javoblarni boshqarish</p>
        </div>
