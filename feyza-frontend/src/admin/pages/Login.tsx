  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[hsl(30,50%,98%)] to-[hsl(340,40%,96%)] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative">
          ...
          <div className="inline-flex items-center justify-center w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-br from-pink-400 to-rose-400 shadow-lg shadow-pink-200/50 mb-3 md:mb-4">
            <Sparkles className="w-7 h-7 md:w-8 md:h-8 text-white" />
          </div>
          <h1 className="text-3xl md:text-4xl font-body font-bold bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent">
            Admin Panel
          </h1>
          <p className="text-sm md:text-base text-foreground/70 mt-1 md:mt-2">Xush kelibsiz</p>
        </div>

        <div className="bg-white/70 backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 shadow-xl shadow-pink-100/50 border border-white/50">
          {error && (
